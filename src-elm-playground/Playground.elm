...
gameUpdate : (Computer -> memory -> memory) -> Msg -> Game memory -> ( Game memory, Cmd msg )
gameUpdate updateMemory msg (Game vis memory computer) =
    ( case msg of
        ...
        MouseButtonUp ->
            Game vis memory { computer | mouse = mouseDown False computer.mouse }

        SvgMouseClick ->
            Game vis memory { computer | mouse = mouseClick True computer.mouse }

        SvgMouseButtonDown ->
            Game vis memory { computer | mouse = mouseDown True computer.mouse }

        SvgMouseOver ->
            Game vis memory { computer | mouse = mouseOver True computer.mouse }

        SvgMouseOut ->
            Game vis memory { computer | mouse = mouseOver False computer.mouse }
...
mouseOver : Bool -> Mouse -> Mouse
mouseOver bool mouse =
    { mouse | over = bool }
    ...
    svg
        ([ viewBox (x ++ " " ++ y ++ " " ++ w ++ " " ++ h)
         ...
         , height "100%"
            ...
            ++ (case maybeMsg of
                    Just msg ->
                        [ Svg.Events.onClick msg.onClick
                        , Svg.Events.onMouseDown msg.mouseButtonDown
                        , Svg.Events.onMouseOver msg.onMouseOver
                        , Svg.Events.onMouseOut msg.onMouseOut
                        ]
